...
- [x] Авторизация с подтверждением аккаунта через почту
- [x] Разработка модального окна для авторизации и аутентификации 
- [x] Работа с формами для авторизации и аутентификации
- [x] Разработка логики для бронировки мест на аукцион
- [x] Реализовал Таймер-компонент который работает отталкиваясь от реального времени (независимо от перезагрузки страницы)
- [x] Логика валидации для участия в аукционах
- [x] Логика фильтрации/сортировки товаров на аукцион
- [x] Верстка целых страниц и отдельных компонентов
